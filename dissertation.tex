...
\documentclass[%
  ...
  % sansseriftumtext,           % sans serif tum and lis text (!changes the font)
]{tumDiss}
...
% If you want to use it, its best to work with it from the very start. Adding it
% when finishing your dissertation might get you into trouble.
%
